...
export function BottomNav({ activeTab, onTabChange, hidden = false }: BottomNavProps) {
  ...
  return (
    <div
      className={`absolute z-40 bottom-0 left-0 right-0 bg-white/80 backdrop-blur-xl border-t border-white/50 px-4 pb-6 pt-3 rounded-t-3xl shadow-lg transition-transform duration-300 ease-out ${
